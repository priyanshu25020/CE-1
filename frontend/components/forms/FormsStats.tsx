...
import { FileText, Navigation, CheckCircle2, Users, ArrowUp } from 'lucide-react';

export default function FormsStats() {
  const stats = [
    {
      id: 1, title: 'Total Forms & Polls', value: '32', subtitle: 'All Time',
      icon: FileText, color: 'text-purple-400', bg: 'bg-purple-500/10', border: 'border-white/[0.05]',
      glow: 'group-hover:shadow-[0_0_30px_-5px_rgba(192,132,252,0.3)] group-hover:border-purple-500/30'
    },
    {
      id: 2, title: 'Active', value: '18', subtitle: 'Currently Running',
      icon: Navigation, color: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-white/[0.05]',
      glow: 'group-hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.3)] group-hover:border-blue-500/30'
    },
    {
      id: 3, title: 'Responses', value: '1,248', subtitle: 'Total Responses',
      icon: CheckCircle2, color: 'text-orange-400', bg: 'bg-orange-500/10', border: 'border-white/[0.05]',
      glow: 'group-hover:shadow-[0_0_30px_-5px_rgba(249,115,22,0.3)] group-hover:border-orange-500/30'
    },
    {
      id: 4, title: 'Participation Rate', value: '76%', subtitle: <span className="flex items-center gap-1 text-emerald-400"><ArrowUp className="w-3 h-3" /> 12% this month</span>,
      icon: Users, color: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-white/[0.05]',
      glow: 'group-hover:shadow-[0_0_30px_-5px_rgba(16,185,129,0.3)] group-hover:border-emerald-500/30'
    }
  ];
