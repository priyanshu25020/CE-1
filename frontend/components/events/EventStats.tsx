...
import { CalendarDays, Send, UserCheck, Users, ArrowUp } from 'lucide-react';

export default function EventStats() {
  const stats = [
    {
      id: 1, title: 'Total Events', value: '24', subtitle: 'All Events',
      icon: CalendarDays, color: 'text-purple-400', bg: 'bg-purple-500/10', border: 'border-white/[0.05]',
      glow: 'group-hover:shadow-[0_0_30px_-5px_rgba(192,132,252,0.3)] group-hover:border-purple-500/30'
    },
    {
      id: 2, title: 'Updates Sent', value: '19', subtitle: 'This Month',
